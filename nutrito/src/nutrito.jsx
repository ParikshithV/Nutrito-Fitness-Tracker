...
export default class LogIn extends Component {
    ...
    onSubmit(e) {
      ...
      axios.post('http://localhost:8080/save', encodeForm(data), {headers: {'Accept': 'application/json'}})
        ...
        <Container text>
          <div class="form-out-box">
              <div>
               ...
               <div>
                 <Form className="form" method="post" onSubmit={this.onSubmit} action="http://localhost:4000/nutrito">
                 <div class = "field">
